...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	public boolean deleteContentgory(Long id) {
		...
		TbContentCategory pcateGory = tbContentCategoryMapper.selectByPrimaryKey(cateGory.getParentId());
		pcateGory.setIsParent(false);
		tbContentCategoryMapper.updateByPrimaryKey(pcateGory);
		return true;
	}
